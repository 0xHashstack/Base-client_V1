...
function Sidebar({ className }: { className?: string }) {
	...
	return (
		<aside
			ref={sidebarRef}
			className={cn(
				'z-30 h-screen bg-sidebar-bg transition-all duration-300 ease-in-out px-2.5 flex flex-col overflow-x-hidden w-[90vw] max-w-[300px] text-primary-600 shadow-2xl',
